    ...
    <div class="row">
      <div class="col-3 col-12-medium">
        ...
        <section>
          ...
          <ul class="link-list">
            <li><a href="#">LaRepubblica</a></li>
            <li><a href="#">Il Corriere della Sera</a></li>
            <li><a href="#">RTL 102.5</a></li>
            <li><a href="#">Il manifesto</a></li>
          </ul>
        </section>
      ...
      <div class="col-6 col-12-medium imp-medium">
        ...
        <section>
          <header>
            <h2>Blog</h2>
            <h3>Visita il nostro blog per restare sempre aggiornato!</h3>
          </header>
          <p>
