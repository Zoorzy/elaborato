  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-3 col-6-medium col-12-small">
        ...
        <!-- Feature #3 -->
        <section>
          <a href="#" class="bordered-feature-image"><img src="/elaborato/images/pic03.jpg" alt="" /></a>
          <h2>License Info</h2>
          <p>
      ...
      <div class="col-3 col-6-medium col-12-small">
        ...
        <!-- Feature #4 -->
        <section>
          <a href="#" class="bordered-feature-image"><img src="/elaborato/images/pic04.jpg" alt="" /></a>
    ...
    <div class="row aln-center">
      ...
      <div class="col-4 col-6-medium col-12-small">
        ...
        <section>
          ...
          <ul class="quote-list">
            <li>
              <img src="/elaborato/images/pic06.jpg" alt="" />
              <p>"Neque nisidapibus mattis"</p>
              <span>Jane Doe, CEO of UntitledCorp</span>
            </li>
            <li>
              <img src="/elaborato/images/pic07.jpg" alt="" />
              <p>"Lorem ipsum consequat!"</p>
              <span>John Doe, President of FakeBiz</span>
            </li>
            <li>
              <img src="/elaborato/images/pic08.jpg" alt="" />
